...
{
    public class CuttingCardScanPageViewModel : ViewModelBase, INotifyPropertyChanged
    {
        public CuttingCardScanPageViewModel(INavigationService navigationService, IPageDialogService pageDialogService)
            ...
            set
            {
                ...
                if(!string.IsNullOrEmpty(QRCode))
                {
                    if(QRCode.Length==12)
                    {
                        ...
                        NavigationService.NavigateAsync("CuttingCardPage", parameter);
                    }    
                }    
            }
        }
        ...
        public async Task ViewCuttingCardCommandHandler()
        {
            ...
            await NavigationService.NavigateAsync("CuttingCardPage", parameter);
