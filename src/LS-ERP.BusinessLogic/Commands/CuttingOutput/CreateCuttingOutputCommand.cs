...
{
    public class CreateCuttingOutputCommand : CommonAuditCommand,
        IRequest<CommonCommandResultHasData<CuttingOutput>>
    {
        ...
        public List<CuttingOutputSizeRatio> ListSizeRatio { get; set; }
        public List<CuttingOutputLot> CuttingLot { get; set; }
