...
{
    public partial class IssuedFabricRequest_ViewController : ObjectViewController<ListView, FabricRequest>
    {
        public IssuedFabricRequest_ViewController()
        {
            InitializeComponent();
            PopupWindowShowAction issuedFabricAction = new PopupWindowShowAction(this, "IssuedFabricRequestAction",
            ...
            issuedFabricAction.SelectionDependencyType = SelectionDependencyType.RequireSingleObject;
        ...
        private void IssuedFabricAction_CustomizePopupWindowParams(object sender, CustomizePopupWindowParamsEventArgs e)
        {
            ...
            var current = View.CurrentObject as FabricRequest;
            ...
            if (current != null)
            {
                model.FabricRequestDetails = current.Details;
                model.Description = "[" + current.CustomerStyleNumber + "] - " + current.OrderNumber;
                model.FabricRequestID = current.ID;
                model.Customer = objectSpace.GetObjectByKey<Customer>(current.CustomerID);
            }
