...
{
    public class GA_ClonePackingListProcess
    {
        public static List<PackingLine> GeneratePacking(List<PackingLine> packingLines, Dictionary<string,string> itemStyles,
