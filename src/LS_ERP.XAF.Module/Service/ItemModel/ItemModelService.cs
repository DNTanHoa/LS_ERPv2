...
namespace LS_ERP.XAF.Module.Service
{
    ...
    {
        public async Task<CommonRespone> ImportItemModel(ImportUPCRequest request)
        {
            using (var client = new HttpClient())
            {
                ...
                try
                {
                    var response = client.PostAsync(ConfigurationManager.AppSettings.Get("ImportUPC").ToString(),
