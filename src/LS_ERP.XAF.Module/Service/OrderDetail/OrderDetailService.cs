...
namespace LS_ERP.XAF.Module.Service
{
    ...
    {
        public async Task<CommonRespone> CancelOrderDetail(CancelOrderDetailRequest request)
        {
            using (var client = new HttpClient())
            {
                ...
                try
                {
                    var response = client.PostAsync(ConfigurationManager.AppSettings.Get("OrderDetailCancel").ToString(),
