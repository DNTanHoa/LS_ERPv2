...
{
    public class SalesContractDetailSqlServerConfiguration
        : SalesContractDetailConfiguration
    {
        public override void Configure(EntityTypeBuilder<SalesContractDetail> builder)
        {
