...
{
    public class FabricRequestDetailLogSqlServerConfiguration : FabricRequestDetailLogConfiguration
    {
        public override void Configure(EntityTypeBuilder<FabricRequestDetailLog> builder)
        {
