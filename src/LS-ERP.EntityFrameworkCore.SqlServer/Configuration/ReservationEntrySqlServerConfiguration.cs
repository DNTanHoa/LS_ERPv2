...
{
    public class ReservationEntrySqlServerConfiguration
        : ReservationEntryConfiguration
    {
        public override void Configure(EntityTypeBuilder<ReservationEntry> builder)
        {
