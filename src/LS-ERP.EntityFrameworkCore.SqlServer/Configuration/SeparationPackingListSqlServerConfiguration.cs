...
{
    public class SeparationPackingListSqlServerConfiguration : SeparationPackingListConfiguration
    {
        public override void Configure(EntityTypeBuilder<SeparationPackingList> builder)
        {
