...
{
    public class PackingOverQuantitySqlServerConfiguration : PackingOverQuantityConfiguration
    {
        public override void Configure(EntityTypeBuilder<PackingOverQuantity> builder)
        {
