...
{
    public class PurchaseOrderGroupLineSqlServerConfiguration
        : PurchaseOrderGroupLineConfiguration
    {
        public override void Configure(EntityTypeBuilder<PurchaseOrderGroupLine> builder)
        {
