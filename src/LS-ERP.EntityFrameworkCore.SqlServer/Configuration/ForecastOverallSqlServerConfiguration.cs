...
{
    public class ForecastOverallSqlServerConfiguration
        : ForecastOverallConfiguration
    {
        public override void Configure(EntityTypeBuilder<ForecastOverall> builder)
        {
