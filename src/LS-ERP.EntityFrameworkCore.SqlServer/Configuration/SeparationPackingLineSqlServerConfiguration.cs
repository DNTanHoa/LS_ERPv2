...
{
    public class SeparationPackingLineSqlServerConfiguration : SeparationPackingLineConfiguration
    {
        public override void Configure(EntityTypeBuilder<SeparationPackingLine> builder)
        {
