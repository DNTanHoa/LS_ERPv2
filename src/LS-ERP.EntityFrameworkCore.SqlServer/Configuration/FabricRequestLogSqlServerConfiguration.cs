...
{
    public class FabricRequestLogSqlServerConfiguration : FabricRequestLogConfiguration
    {
        public override void Configure(EntityTypeBuilder<FabricRequestLog> builder)
        {
