...
namespace LS_ERP.EntityFrameworkCore.SqlServer.Migrations
{
    ...
    [Migration("20230116070716_updateRemarkForCuttingCard")]
    partial class updateRemarkForCuttingCard
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LS_ERP.EntityFrameworkCore.Entities.DeliveryNote", b =>
                {
                    b.Property<string>("ID")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("LS_ERP.EntityFrameworkCore.Entities.DeliveryNoteDetail", b =>
                {
                    b.Property<string>("ID")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("CuttingCardID")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("LS_ERP.EntityFrameworkCore.Entities.FabricRequestDetail", b =>
                {
                    ...
                    b.Property<decimal?>("SemiFinishedProductQuantity")
                        .HasColumnType("DECIMAL(19,9)");
            ...
            modelBuilder.Entity("LS_ERP.EntityFrameworkCore.Entities.FabricRequestDetailLog", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long>("FabricRequestLogID")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("FabricRequestLogID");

                    b.ToTable("FabricRequestDetailLog");
                });

            modelBuilder.Entity("LS_ERP.EntityFrameworkCore.Entities.FabricRequestLog", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("LS_ERP.EntityFrameworkCore.Entities.Hanger", b =>
                {
                    b.Property<string>("Code")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("LS_ERP.EntityFrameworkCore.Entities.InvoiceDetail", b =>
                {
                    ...
                    b.Property<decimal?>("PriceCM")
                        .HasColumnType("DECIMAL(19,9)");

                    b.Property<decimal?>("PriceFOB")
                        .HasColumnType("DECIMAL(19,9)");
            ...
            modelBuilder.Entity("LS_ERP.EntityFrameworkCore.Entities.ItemModel", b =>
                {
                    ...
                    b.Property<string>("CustomerColorCode")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("LS_ERP.EntityFrameworkCore.Entities.MaterialRequestOrderDetail", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("PercentQuantity")
                        .HasColumnType("int");
                    ...
                    b.ToTable("MaterialRequestOrderDetails");
                });
            ...
            modelBuilder.Entity("LS_ERP.EntityFrameworkCore.Entities.PackingList", b =>
                {
                    ...
                    b.Property<int?>("ParentPackingListID")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("SeparatedOrdinal")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LS_ERP.EntityFrameworkCore.Entities.PartMaster", b =>
                {
                    ...
                    b.Property<string>("ModelLib")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ModelLibProd")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("LS_ERP.EntityFrameworkCore.Entities.ProductionOrder", b =>
                {
                    b.Property<string>("ID")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("ProductionOrderTypeID")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("LS_ERP.EntityFrameworkCore.Entities.ProductionOrderLine", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<DateTime>("BeginProductionDate")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("CustomerOderType")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<DateTime>("EndProductionDate")
                        .HasColumnType("datetime2");

                    b.Property<DateTime>("EstimateSupplierHandOver")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("LS_ERP.EntityFrameworkCore.Entities.ShippingPlanDetail", b =>
                {
                    ...
                    b.Property<decimal>("TotalPriceCM")
                        .HasColumnType("DECIMAL(19,9)");

                    b.Property<decimal>("TotalPriceFOB")
                        .HasColumnType("DECIMAL(19,9)");
            ...
            modelBuilder.Entity("LS_ERP.EntityFrameworkCore.Entities.Shu", b =>
                {
                    b.Property<string>("BarCode")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("LS_ERP.EntityFrameworkCore.Entities.FabricRequestDetailLog", b =>
                {
                    b.HasOne("LS_ERP.EntityFrameworkCore.Entities.FabricRequestLog", "FabricRequestLog")
                        .WithMany("Details")
                        .HasForeignKey("FabricRequestLogID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("FabricRequestLog");
                });
            ...
            modelBuilder.Entity("LS_ERP.EntityFrameworkCore.Entities.FinishGoodTransaction", b =>
                {
                    b.HasOne("LS_ERP.EntityFrameworkCore.Entities.InventoryFG", null)
                        .WithMany("FinishGoodTransactions")
                        .HasForeignKey("InventoryFGID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("LS_ERP.EntityFrameworkCore.Entities.PackingLine", b =>
                {
                    ...
                    b.HasOne("LS_ERP.EntityFrameworkCore.Entities.Hanger", "Hanger")
                        .WithMany()
                        .HasForeignKey("HangerCode");
            ...
            modelBuilder.Entity("LS_ERP.EntityFrameworkCore.Entities.FabricRequest", b =>
                {
                    ...
                    b.Navigation("FabricRequestLogs");
                });
            ...
            modelBuilder.Entity("LS_ERP.EntityFrameworkCore.Entities.InventoryFG", b =>
                {
                    b.Navigation("FinishGoodTransactions");

                    b.Navigation("InventoryDetailFG");
                });
