...
namespace LS_ERP.XAF.Win {
    public partial class XafSplashScreen : SplashScreen {
		private void LoadBlankLogo() {
            ...
            string blankLogoResourceName = assembly.GetName().Name + ".Images.L.svg";
        ...
        public XafSplashScreen() {
            InitializeComponent();
			LoadBlankLogo();
            this.labelCopyright.Text = "Copyright © " + DateTime.Now.Year.ToString() + " Leading Star Garment Company" +  System.Environment.NewLine + "All rights reserved.";
