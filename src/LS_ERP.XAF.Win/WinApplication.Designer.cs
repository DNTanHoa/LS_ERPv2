namespace LS_ERP.XAF.Win {
    partial class XAFWindowsFormsApplication {
        /// <summary> 
        ...
        private void InitializeComponent() {
            ...
            this.module3 = new LS_ERP.XAF.Module.XAFModule();
            this.module4 = new LS_ERP.XAF.Module.Win.XAFWindowsFormsModule();
            ...
            this.securityStrategyComplex1.UserType = typeof(LS_ERP.XAF.Module.BusinessObjects.ApplicationUser);
            // 
            // securityModule1
            // 
            this.securityModule1.UserType = typeof(LS_ERP.XAF.Module.BusinessObjects.ApplicationUser);
            // 
            ...
            this.authenticationStandard1.UserLoginInfoType = typeof(LS_ERP.XAF.Module.BusinessObjects.ApplicationUserLoginInfo);
            //
            // validationModule
            //
            this.validationModule.AllowValidationDetailsAccess = false;
            // 
            // XAFWindowsFormsApplication
            // 
            this.ApplicationName = "LS-ERP.XAF";
            ...
            this.Modules.Add(pivotChartWindowsFormsModule);
            this.Modules.Add(pivotGridModule);
            this.Modules.Add(treeListEditorsWindowsFormsModule);

            this.Modules.Add(this.chartModule);
            this.Modules.Add(this.chartWindowsFormsModule);

            this.UseOldTemplates = false;
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.XAFWindowsFormsApplication_DatabaseVersionMismatch);
            this.CustomizeLanguagesList += new System.EventHandler<DevExpress.ExpressApp.CustomizeLanguagesListEventArgs>(this.XAFWindowsFormsApplication_CustomizeLanguagesList);
        ...
        private LS_ERP.XAF.Module.XAFModule module3;
        private LS_ERP.XAF.Module.Win.XAFWindowsFormsModule module4;
