...
{
    public partial class SumGridPurchaseOrderGroupLine_ViewController 
        : ObjectViewController<ListView, PurchaseOrderGroupLine>
    {
        public SumGridPurchaseOrderGroupLine_ViewController()
        {
            InitializeComponent();
            TargetObjectType = typeof(PurchaseOrderGroupLine);
        ...
        private void gridview_CustomSummaryCalculate(object sender, CustomSummaryEventArgs e)
        {
            ...
            List<PurchaseOrderGroupLine> rows = new List<PurchaseOrderGroupLine>();
            ...
            for (int i = 0; i < selectedRows.Length; i++)
            {
                ...
                {
                    var row = gridView.GetRow(selectedRowHandle) as PurchaseOrderGroupLine;
                    if (row != null)
                        rows.Add(row);
                }
            }
