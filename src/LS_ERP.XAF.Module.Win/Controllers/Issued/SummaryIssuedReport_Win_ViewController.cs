...
{
    public partial class SummaryIssuedReport_Win_ViewController : ObjectViewController<ListView, IssuedReportDetail>
    {
        public SummaryIssuedReport_Win_ViewController()
        {
            InitializeComponent();
        }
        ...
        private void gridview_CustomSummaryCalculate(object sender, CustomSummaryEventArgs e)
        {
            ...
            List<IssuedReportDetail> rows = new List<IssuedReportDetail>();
            ...
            for (int i = 0; i < selectedRows.Length; i++)
            {
                ...
                {
                    var row = gridView.GetRow(selectedRowHandle) as IssuedReportDetail;
                    if (row != null)
                        rows.Add(row);
                }
            }
