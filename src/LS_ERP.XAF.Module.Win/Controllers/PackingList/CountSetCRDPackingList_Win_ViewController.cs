...
{
    public class CountSetCRDPackingList_Win_ViewController
        : ObjectViewController<ListView, PackingListPopupModel>
    {
        public CountSetCRDPackingList_Win_ViewController()
        {
            TargetObjectType = typeof(PackingListPopupModel);
        ...
        private void gridview_CustomCount(object sender, CustomSummaryEventArgs e)
        {
            ...
            List<PackingListPopupModel> rows = new List<PackingListPopupModel>();
            ...
            for (int i = 0; i < selectedRows.Length; i++)
            {
                ...
                {
                    var row = gridView.GetRow(selectedRowHandle) as PackingListPopupModel;
                    if (row != null)
                        rows.Add(row);
                }
            }
