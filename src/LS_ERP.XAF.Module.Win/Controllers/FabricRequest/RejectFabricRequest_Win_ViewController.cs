...
{
    public class RejectFabricRequest_Win_ViewController : RejectFabricRequest_ViewController
    {
        public override void RejectFabricRequest_Execute(object sender, PopupWindowShowActionExecuteEventArgs e)
        {
            base.RejectFabricRequest_Execute(sender, e);
            ...
            if (fabricRequest != null)
            {
                ...
                ///Make message
                var contentTemplate = ObjectSpace.GetObjectByKey<MessageTemplate>("RejectFabricRequestMailTemplate");
                ...
                {
                    Subject = "Reject for Fabric request - " + DateTime.Now.ToString("MM/dd/yyyy HH:mm:ss"),
                ...
                if (updateResponse != null)
                {
                    if (updateResponse.Result.Code == "000")
                    {
                        ...
                        if (sendMailResult)
                        {
                            ...
                            fabricUpdate.Status = objectSpace.GetObjectByKey<Status>("R");
                            fabricUpdate.StatusID = "R";
                            fabricUpdate.Remark += popupObject.Remarks;

                            fabricRequest.Status = objectSpace.GetObjectByKey<Status>("R");
                            fabricRequest.StatusID = "R";
                            fabricRequest.Remark += popupObject.Remarks;
